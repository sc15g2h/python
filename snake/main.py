...
def game_over():
    ...
    button1 = Button(window, text = "Quit" , anchor = W, command=Close)
    button1.configure(width = 10, height=2, bg='red', relief = FLAT)
    button2 = Button(window, text = "Restart" , anchor = W, command=Restart)
...
window = Tk()
window.title("Let them eat! Snake!")
